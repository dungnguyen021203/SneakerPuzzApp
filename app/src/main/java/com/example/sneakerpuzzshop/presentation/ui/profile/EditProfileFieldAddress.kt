...
fun EditProfileFieldAddress(
    ...
    val profileState = profileViewModel.editUserAddress.collectAsState()
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = {
                    Text(text = "Change Address", fontWeight = FontWeight.Bold)
                },
                navigationIcon = {
                    IconButton(onClick = {
        ...
        Column(
            ...
            Text(
                text = "Use real address for easier shipping. This address will appear on multiple pages",
                fontSize = 16.sp,
                color = Color.Gray
            )
            TextField(
                ...
                leadingIcon = {
                    Icon(Icons.Rounded.LocationOn, contentDescription = "Account Leading Icon")
                },
            ...
            Button(
                onClick = {
                    profileViewModel.updateUserAddress(userId = userId, userAddress = address)
                },
                modifier = Modifier
                    .fillMaxWidth()
                    .height(48.dp),
